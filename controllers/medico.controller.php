...
switch ($_GET['op']) {  //TODO: Clausula de desicion para obtener variable tipo GET
    ...
    case 'todos':
        ...
        case 'insertar':
            ...
            $datos = $Medico->Insertar($medico_cod,$medico_ape,$medico_nom,$medico_esp,$medico_tel,$medico_cor);
            ...
            case 'actualizar':
                ...
                $medico_cor = $_POST['medico_cor'];     
                $datos = array();        
                $datos = $Medico->Actualizar($medico_cod,$medico_ape,$medico_nom,$medico_esp,$medico_tel,$medico_cor);        
                //$respuesta = mysqli_fetch_assoc($datos);        
                echo json_encode($datos);        
                break;
